export const about = {
  ...
  pillars: [
    {
      title: "The problem",
      text: "Rostering, payroll, compliance, and coordination spread across disconnected tools, creating admin burden and gaps in care.",
    },
    {
      title: "Inspired by flow",
      text: "From Pravaha, meaning movement and continuous progression. A future where care operations move effortlessly.",
    },
    {
    ...
    },
    {
      ...
      text: "Care teams, schedulers, agencies, and administrators, all collaborating on tools designed around how they actually work.",
    },
  ],
  mission:
