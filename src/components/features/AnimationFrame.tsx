    ...
    return (
      <div
        ...
        className={cn(
          ...
          "bg-gradient-to-br from-white via-slate-50/80 to-teal/[0.06]",
          "shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_20px_40px_-24px_rgba(11,29,58,0.25)]",
          "ring-1 ring-navy/[0.06]",
          className
        )}
      >
        <div className="pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-teal/10 blur-2xl" />
        <div className="pointer-events-none absolute -bottom-10 -left-6 h-28 w-28 rounded-full bg-blue/10 blur-2xl" />
...
export function StepLabel({ children, color = "teal" }: { children: ReactNode; color?: "teal" | "blue" | "purple" }) {
  const colors = {
